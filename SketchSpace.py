...
cv2.namedWindow("Canvas", cv2.WINDOW_NORMAL)  # Allows resizing of the canvas window
cv2.namedWindow("Image", cv2.WINDOW_NORMAL)   # Allows resizing of the image window
